...
<html>
	...
	<script type="text/javascript"> 
		...
		xmlhttp2.onreadystatechange=function(){
			if (xmlhttp2.readyState==4 && xmlhttp2.status==200){
				if(xmlhttp2.responseText.indexOf("data/") == 0){
					window.location.href=xmlhttp2.responseText;
				}else{
					alert("导出状态失败:" + xmlhttp2.responseText);
				}
		...
		function outdata() {
			...
			xmlhttp2.open("POST", "status_resp.jsp?act=outdata&ids=" + ids);
			xmlhttp2.send(null);
		}
  ...
  <body>
	...
	<div id="content" style="width:1150px; height:540px; border:1px solid #555; overflow:auto; word-wrap:break-word;float: left;margin-left: 15px;">
		...
		<input type="button" value="导出" onclick="outdata()" style="float:right; margin-right:20px; margin-top:20px; height:30px;width: 80px;"/>&nbsp;&nbsp;
	</div>
  </body>
  <script>
