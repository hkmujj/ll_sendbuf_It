...
%><%
	...
	logger.info("zhuowang return entry1");
	
	Map<String, String[]> paramMap = request.getParameterMap();
	if(paramMap != null){
		for(Entry<String, String[]> param : paramMap.entrySet()){
			logger.info("zhuowang return key = " + param.getKey() + ", value = " + param.getValue()[0]);
		}
		logger.info("zhuowang get request uri ################ = " + request.getRequestURI().toString());
	}
