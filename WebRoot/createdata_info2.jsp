...
%><%!
	...
	public static String CreateXLS(String dataStart , String dataEnd , String userid) {
		...
		try{ 
			...
			Label label12 = new Label(11,0,"客户订单");
			//将定义好的单元格添加到工作表中 
...
//			String passwd="123456";
			...
			while(true){
				...
				sqlbuf.append("sd_userid,SD_PHONE,SD_PACKAGEID,SHOW_PROVINCE(SDX_PROVINCE) as 省份,SDX_PRICE,SDX_MONEY,MT_DISCONT,SDX_PRICE*MT_DISCONT/10,SDS_TIME,if(RP_CODE='0','成功',if(RP_CODE is null,'充值中','失败')),if(sdx_net=1,'移动',if(sdx_net=2,'联通','电信')),sd_linkid");
			...
			while (rs.next()) {
				...
				String linkid = rs.getString("sd_linkid");
				...
				Label lab12 = new Label(11,row,linkid);
				...
				sheet.addCell(lab12);
					...
					Label label12_2 = new Label(11,0,"客户订单");
					//将定义好的单元格添加到工作表中 
					...
					Label lab12_2 = new Label(11,row,linkid);
					...
					lab12_2 = new Label(11,row,linkid);
