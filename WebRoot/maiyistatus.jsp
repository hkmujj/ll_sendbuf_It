<%@page
	...
	public static String getNameValuePairRequest(String url, String userid, String encode, Map<String, String> header, String mark) {
		String bacTxt = null;
		...
		for (int i = 0; i < idarray.length; i++) {
			...
			if (ret != null && ret.trim().length() > 0) {
				...
				try {
					...
					logger.info("maiyi status : " + e.getMessage() + ", ret = " + ret + "@" + TimeUtils.getSysLogTimeString());
				}
			} else {
				logger.info("maiyi status : " + "fail@" + TimeUtils.getSysLogTimeString());
			}
		}
