...
<%
	...
	while (true) {
		...
		String UId = routeparams.get("UId");
		if (UId == null) {
			request.setAttribute("result", "S." + routeid + ":wrong routeparams, UId is null@" + TimeUtils.getSysLogTimeString());
			break;
		}
		...
		String sendurl = "http://10.170.165.150:8164/junbo/junbosend2.jsp";
		...
		if (ret != null && ret.trim().length() > 0) {
			...
			try {
				...
				if (retjson.getString("S").equals("100")) {
					...
					request.setAttribute("result", "R." + routeid + ":" + retjson.getString("S") + ":" + message + "@" + TimeUtils.getSysLogTimeString());
				}
