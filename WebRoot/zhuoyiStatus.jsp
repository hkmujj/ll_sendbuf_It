...
<%@page import="ec.check.zhuoyi.CheckBatch"%>
...
<%
	...
	try {
		while (true) {
			...
			String UrlReport = routeparams.get("UrlReport");
			if(UrlReport == null){
				request.setAttribute("result", "S." + routeid + ":wrong routeparams, UrlReport is null@" + TimeUtils.getSysLogTimeString());
				break;
			}
