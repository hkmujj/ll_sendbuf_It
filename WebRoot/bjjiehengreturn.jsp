...
%><%
	...
	logger.info("bjjieheng return entry");
	...
	if(str == null){
		logger.info("bjjieheng no request data");
		out.print("no request data");
		return;
	}
	
	logger.info("bjjieheng return str = " + str);
	...
	String taskid = obj.getString("transNo");
	String result = obj.getString("respCode");
	String info = obj.getString("respMsg");
	
	String status = null;
	String mark = "bjjieheng";
	if(result.equals("0000") || result.equals("00000") || result.equals("000000")){
		status = "0";
	}else{
		status = "1";
	}
