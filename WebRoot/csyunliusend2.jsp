		...
		try{
			if(routeid.equals("3121")){
				...
				if(packageid.equals("lt.20M")){
					...
					packagecode = "10002926";
				}else if(packageid.equals("lt.50M")){
					packagecode = "10002927";
				}else if(packageid.equals("lt.100M")){
					packagecode = "10002928";
				}else if(packageid.equals("lt.200M")){
					packagecode = "10002929";
				}else if(packageid.equals("lt.300M")){
					packagecode = "10002930";
				}else if(packageid.equals("lt.500M")){
					packagecode = "10002931";
				}else if(packageid.equals("lt.1G")){
					packagecode = "10002932";
				}				
			}else if(routeid.equals("2062")){
				//合肥后向+安徽联通 省内漫游
				if(packageid.equals("lt.20M")){
					packagecode = "10002280";
				}else if(packageid.equals("lt.30M")){
					packagecode = "10002281";
				}else if(packageid.equals("lt.50M")){
					packagecode = "10002282";
				}else if(packageid.equals("lt.100M")){
					packagecode = "10002283";
				}else if(packageid.equals("lt.200M")){
					packagecode = "10002284";
				}else if(packageid.equals("lt.500M")){
					packagecode = "10002285";
				}				
