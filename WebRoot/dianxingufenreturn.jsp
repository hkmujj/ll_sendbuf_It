...
%><%
	...
	logger.info("dianxingufen return entry1");
	
	Map<String, String[]> paramMap = request.getParameterMap();
	if(paramMap != null){
		for(Entry<String, String[]> param : paramMap.entrySet()){
			logger.info("dianxingufen return key = " + param.getKey() + ", value = " + param.getValue()[0]);
		}
	}
	...
	if(str == null){
		logger.info("dianxingufen no request data");
		out.print("no request data");
		return;
	}
	
	logger.info("dianxingufen return str = " + str);
	...
	String taskid = obj.getString("request_no");
	String result = obj.getString("result_code");
	
	String status = null;
	String info = result;
	String mark = "dianxingufen";
