...
public class StringUtil {
	...
	/**
	 * 判断一个字符串是否为null或是空字符串或者 null字符<p>
	 *
	 * @param str The string for checking
	 * @return true if the string is neither null nor empty string
	 */
...
*/	
	...
	static public void main(String[] args) {
		System.out.println("md5="+md5("18002262261_zw20156755642"));
		
		System.out.println("md5="+md5("18028680178_zw20156755642"));
		
		//byte [] a = {32, 35};
		
		/*		String[] strs = StringUtil.splitStr("abcdfbad", "b");
		...
		//System.out.println( new String(hex2Bytes(toHex("Rg_bRbiIa_P0Bm7LsnqdFA==".getBytes()))));
		System.out.println(base64Decode("bmFnaW9zYWRtaW46YWRtaW4="));
